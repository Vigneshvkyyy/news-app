...
class TechnologyCategory extends StatefulWidget {
  @override
  _TechnologyCategoryState createState() => _TechnologyCategoryState();
}

class _TechnologyCategoryState extends State<TechnologyCategory> {
  ...
  Future<void> fetchNews() async {
    final response = await http.get(
      Uri.parse(
          'https://gnews.io/api/v4/top-headlines?topic=technology&token=7256acfa88ecf5f4bc4688a64449aedf'),
    );
...
class TechnologyDetailScreen extends StatefulWidget {
  final Map<String, dynamic> technologyNews;

  TechnologyDetailScreen({required this.technologyNews});
      ...
      body: Container(
        ...
        child: Column(children: [
          ClipRRect(
            ...
            child: Image.network(
              widget.technologyNews["image"] ?? "No Images", 
              height: 180,
          ...
          Text(
            widget.technologyNews['title'] ?? 'No title',
          ...
          Row(
            children: [
              ...
              Text(
                widget.technologyNews['source']['name'] ?? 'No author',
                maxLines: 1,
                style: TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
              ...
              Flexible(
                child: Text(
                  widget.technologyNews['publishedAt'] ?? 'No publishedAt',
                  maxLines: 1,
                  style: TextStyle(
                      fontSize: 14,
                      color: Colors.grey),
          ...
          Text(
            widget.technologyNews['description'] ?? 'No description',
            maxLines: 4,
            style: TextStyle(
                fontSize: 14,
                color: Colors.black),
          ...
          Text(
            widget.technologyNews['content'] ?? 'No content',
            maxLines: 4,
            style: TextStyle(
                fontSize: 14,
                color: Colors.black),
